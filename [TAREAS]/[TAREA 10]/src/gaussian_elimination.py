...
def eliminacion_gaussiana_L(A: np.ndarray, b: np.ndarray) -> np.ndarray:
    ...
    ----------
    A : np.ndarray
        Matriz aumentada del sistema de ecuaciones lineales. Debe ser de tamaño n-by-(n+1), donde n es el número de incógnitas.
    b : np.ndarray
    ...
    -------
    np.ndarray
        Vector con la solución del sistema de ecuaciones lineales.
    """
